...
this.index = 0;
//如果没有dom的话，就默认监听body;
this.dom = document.querySelector('svg');
...
var newValue = record.target.textContent 
_this.list.push({
"undo" : function() {
_this.disconnect();
...
"undo" : function() {
_this.disconnect();
target.setAttribute(attributeName, oldValue==null? "":oldValue);
_this.reObserve();
},
"redo" : function () {
_this.disconnect();
target.setAttribute(attributeName, newValue==null? "":newValue);
_this.reObserve();
}
});
};
